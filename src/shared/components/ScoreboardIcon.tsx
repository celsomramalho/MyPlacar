...
export const ScoreboardIcon = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
  ...
  >
    ...
    <rect x="9" y="15" width="2" height="6" rx="1" stroke="white" strokeWidth="1.5" fill="none" />
    <rect x="17" y="13" width="10" height="10" rx="1" fill="#3b82f6" />
    <path d="M21 16H23L21 20H23" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
